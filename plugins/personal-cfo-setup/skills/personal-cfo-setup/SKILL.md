...
- **Investments & Retirement** — IRA, 401(k), pension, brokerage, stock-plan, and other retirement or investment statements for accounts that Finances does not already capture. For an account that is connected and available in Finances, do not ask for a duplicate routine statement; upload only supporting records Finances cannot provide, such as plan documents or cost-basis records.
